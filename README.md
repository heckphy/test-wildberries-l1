...
Интерфейс - это определение, которое описывает поведение других типов
Если конкретно, то он определяет и описывает методы
...
new используется для выделения памяти и инициализации указателей на типы данных
